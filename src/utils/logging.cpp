...
*
*   Merged logging implementations (formerly log_as_syslog.cpp and log_as_logprint.cpp)
*/
...
// ============================================================================
// Section: Main Logging Implementation (from log_as_logprint.cpp)
// ============================================================================
...
// ============================================================================
// Section: Syslog-style Logging (from log_as_syslog.cpp)
// ============================================================================
...
{
    // For Emscripten/WASM, output to stderr
    va_list args;
